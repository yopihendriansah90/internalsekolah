...
class TeachingAssignmentForm
{
    public static function configure(Schema $schema): Schema
    {
        return $schema
            ->components([
                AdminSection::make('Penugasan Inti')
                    ->description('Tautkan guru, mapel, dan kelas agar distribusi mengajar lebih jelas.')
                    ...
                    ->columns(2),
                AdminSection::make('Beban dan Status')
                    ->description('Atur jam mengajar, status penugasan, dan masa berlakunya.')
